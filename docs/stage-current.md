...
| 17 | V1 深度 | 服务端零钱回收与冻结式兑现闭环 | `IN_PROGRESS` | 实现 V8 迁移、状态机、available 保护、API 和 PostgreSQL 并发门禁 |
| 18 | V1 Android | 双视角排版、奖励浏览与教学视频任务 | `IN_PROGRESS` | 当前优先完成 Compose 交互、原创视频任务闭环和 v0.3.2 Release |
