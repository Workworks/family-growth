...
| 任务提交、审核与奖励 | 本地基础实现/单测通过 | 3、13 | Stage 13 evidence |
| Wallet/Ledger | 本地基础实现/单测通过 | 4、13 | Stage 13 evidence |
| 压岁钱、兑换与零钱回收待审 | 本地基础实现/单测通过 | 5、13 | Stage 13 evidence |
...
| Stage 3–10 生产服务端深化 | 未开始 | 3–10 | Stage 路线图 |
| V1 总验收 | 未开始 | 10 | 待补 |
