...
| 压岁钱、兑换与零钱回收待审 | 礼金/双向兑换和 Stage 17 冻结式零钱回收服务端通过；真机回放待验收 | 5、17 | Stage 5/17 evidence |
| 奖励商店、储蓄与愿望 | 服务端 H2/PostgreSQL 闭环通过 | 6、13 | Stage 6 evidence |
| 奖励预算、兑换审批与现实履约 | Stage 28 服务端、并发和 Android 可离线工程通过；目标平板待验收 | 28 | Stage 28 evidence |
