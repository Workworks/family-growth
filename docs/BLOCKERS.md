...
当前工作：孩子“我的任务/自主学习”、五级教材选择、受限官方 WebView，以及 V10 家长免费来源/动态栏目/儿童无 URL 投影的离线门禁已完成；不可变课程版本等共用教学表从 V11 继续，九类活动、题目版本、Assignment/Attempt/Completion/MasteryEvidence、生产 API 和 Android 课程同步仍在建设。
