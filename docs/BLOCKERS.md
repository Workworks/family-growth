...
记录所有未达到 `COMPLETED` 的 Stage 及其缺少条件。**最后更新：2026-08-31。**

本清单区分两类：

- **外部阻塞**：缺少项目无法自行提供或未经授权影响共享环境的设备、仓库、凭据或第三方能力。代码可能已完成，但真实验收无法执行；不得用 Mock、构建或文档代替。
- **工程未完成**：能力在本项目范围内，只是尚未建设，继续按 Stage 开发即可；REQ-051 审计已确认 Stage 27–32 深化范围。
...
已发布：REQ-045 的 v0.3.6/12 是 Stage 21 首个发布里程碑；该能力随后进入当前 latest v0.3.8/14，两版公开 digest、包名、版本和既有稳定证书均复验通过。远端发布不替代下述设备验收。
