...
解除方式：后续统一发布新版本；用户提供目标平板后由 Agent 回放运行态。发布成功不替代设备验收。
...
解除方式：后续统一发布新版本；用户提供目标平板后由 Agent 按 V24-07 回放。发布成功不替代设备验收。
...
解除方式：后续统一发布新版本；用户提供目标平板后由 Agent 按 V25-07 回放。发布成功不替代设备验收。
