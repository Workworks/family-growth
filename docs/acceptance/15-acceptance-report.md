...
Stage 3–7/9 已交付 PostgreSQL 生产闭环，Stage 8 API/Android 可离线接入已完成，Stage 10 已完成生产配置、恢复演练、全量自动化和公开稳定签名 v0.3.0 Release。安装交互、重启持久化和 App 内覆盖升级仍缺真实平板。
...
| Android 单测/lint/0.3.0 APK | `PASS（本地/CI/公开下载复验）` | [Stage 10 证据](../evidence/stage-10/acceptance.json) |
...
完整 V1 仍需 Stage 8/10 真机回放、AC-V1-13/17 的数据权利与防沉迷深度、旧数据逐项保留验收；REQ-030/031 新增的全面教学体系与幼儿园/小学/初中/高中四学段体验属于下一产品主线，不能由现有三个视频样例或换色页面代替。
