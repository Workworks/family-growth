...
REQ-030/031 把全面教学确定为下一产品主线，并按幼儿园、小学、初中、高中重排。Stage 20 的 V9、服务/API、权利目录、四学段 Android 路由和全部离线门禁已完成，只缺目标平板运行态而保持 `BLOCKED`；Stage 21–26 仍是规划，建立对应 Spec 前不进入上方状态表。
