...
| 24 | 全面教学初中深度 | 初中学科实验台 | `IN_PROGRESS` |
...
REQ-030/031 把全面教学确定为下一产品主线，并按幼儿园、小学、初中、高中重排。Stage 20–23 的可离线范围均已完成，因目标平板/服务验收保持 `BLOCKED`。REQ-050 授权连续交付后，Stage 24 已完成 Spec 初始化并进入初中学科实验台实现；Stage 25–26 仍为规划，建立对应 Spec 前不进入上方状态表。
