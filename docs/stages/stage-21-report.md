...
| WP21-7 | 已完成 | v0.3.5/11 稳定发布：版本递增、发布前门禁、阶段提交、tag workflow、远端 APK digest/包名/版本/同证书复验和文档证据 |
...
| V21-07 | GitHub Actions/Release | 递增 v0.3.5/11，推送 commit/tag，等待 workflow，下载公开 APK 并检查 digest、包名、版本和证书 | Release 为 latest；工作流不覆盖同名资产，版本递增且与 v0.3.4 同一稳定证书 | Stage 21 evidence/Release URL |
...
- [x] AC21-07：`PASS_RELEASE` — v0.3.5/11 本地与 CI release JVM/lint/assemble 通过，tag/versionName 一致；公开资产 11,584,931 bytes，GitHub digest 与下载 SHA-256 均为 `8edc85a6feae7cf7071815115096e8d4c1bb7ab54eac121191fcc2be3ef9c56b`，包名 `com.familygrowth.android`，证书 SHA-256 与 v0.3.4 同为 `9179a5da2973e8ff9115edd1fb74e21ad70d9540c1d33203c9af442106d2eacb`。真机覆盖升级仍归 AC21-06/Stage 11/14。
...
- 2026-08-29 已发布 [Family Growth v0.3.5](https://github.com/Workworks/family-growth/releases/tag/v0.3.5)，workflow run `33190582209` 成功。Release 将 Stage 20/21 工程能力交付为稳定 APK，但不改变 AC21-06 的目标平板阻塞状态。
