...
| P1 | 25 | `NOT_STARTED` | 建立高中阶段 Spec，建设目标规划、课程深度、自主节奏和家长事实视图 | Agent | Stage 25 Spec、代码、门禁与 evidence |
...
Stage 20–24 的可离线工程与门禁已经收口，只剩目标平板/服务验收。按 REQ-050 不再因普通产品偏好暂停：下一步连续进入 Stage 25、26；LIM-013 数据权利、完整 App 内防沉迷和 Android 生产接入在 Stage 26 作为 P0 收口。完整拆分见 [教学与项目剩余事项清单](requirements/teaching-and-project-backlog.md)。
