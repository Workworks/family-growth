...
class JpaFamilyGrowthStore implements FamilyGrowthStore {
 ...
 public ParentProfile save(ParentProfile v){var e=new ParentEntity();e.id=v.id();e.familyId=v.familyId();e.displayName=v.displayName();e.createdAt=v.createdAt();parents.save(e);return v;}
 public ChildProfile save(ChildProfile v){var e=new ChildEntity();e.id=v.id();e.familyId=v.familyId();e.displayName=v.displayName();e.birthDate=v.birthDate();e.ageStage=v.ageStage().name();e.createdAt=v.createdAt();children.save(e);return v;}
